...
namespace Payum2\Heartland\Model;

use Payum2\Heartland\Soap\Base\ArrayOfMessage;
use Payum2\Heartland\Soap\Base\Authorization;
use Payum2\Heartland\Soap\Base\AuthorizationType;
use Payum2\Heartland\Soap\Base\MakePaymentResponse;
    ...
    public function setResponse($response)
    {
        ...
        if ($messages = $response->getMessages()) {
            if ($sebMessages = $messages->getMessage()) {
                ...
                /** @var \Payum2\Heartland\Soap\Base\Message $message */
